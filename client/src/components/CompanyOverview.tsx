...
export default function CompanyOverview() {
  ...
  return (
    <section ref={ref} className="py-12 sm:py-16 md:py-20 lg:py-32 bg-background">
      <div className="mx-auto max-w-7xl px-6 md:px-12">
        <div className="grid gap-12 sm:gap-16 md:gap-20 lg:grid-cols-[1fr,2fr] lg:gap-24">
          {/* Left Column - Title */}
          <motion.div className="space-y-4 lg:sticky lg:top-24 lg:self-start" style={{ y, opacity }}>
            <h2 className="text-[40px] sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight" data-testid="text-section-title">
              Free Hill Capital
            </h2>
            <div className="flex items-baseline gap-3">
              <div className="h-px w-12 bg-primary" />
              <p className="text-xl sm:text-2xl md:text-3xl font-medium text-primary" data-testid="text-founded-year">
                Est. 2015
              </p>
            </div>
          </motion.div>
          ...
          >
            <p className="text-base sm:text-lg md:text-xl leading-relaxed text-muted-foreground" data-testid="text-mission-statement">
            ...
            <p className="text-base sm:text-lg md:text-xl leading-relaxed text-muted-foreground" data-testid="text-company-mission">
